    ...
    return (
        <div className="">
            <form onSubmit={handleSubmit}>
                ...
                <div className="flex justify-between w-96 ml-4">
                    {/* Quantity */}
                    <div className="bg-white w-40 flex justify-between p-3 rounded-lg">
                    ...
                    {/* Category Field */}
                    <select className="bg-white w-40 h-[3.25rem] flex p-3 rounded-lg text-black text-md"
                    id="category" 
                    value={category} 
                ...
                {/* Submit Button */}
                <button type="submit" className="bg-indigo-500 hover:bg-indigo-700 font-bold w-96 justify-center m-4 p-3 rounded-lg focus:ring-indigo-400 focus:ring text-white flex">+</button>
            </form>
